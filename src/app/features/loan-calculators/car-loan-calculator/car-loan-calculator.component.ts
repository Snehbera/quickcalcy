...
@Component({
  ...
  templateUrl: './car-loan-calculator.component.html'
})
export class CarLoanCalculatorComponent implements OnInit {
  vehiclePrice: number = 1000000;
  downPayment: number = 200000;
  ...
  calculate() {
    this.loanAmount = Math.max(0, this.vehiclePrice - this.downPayment);
